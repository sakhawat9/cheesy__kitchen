...
export default function OrderSummary({ cartItems = [] }: any) {
  ...
  return (
    <div className="card card-pad">
      ...
      <dl className="pt-4 space-y-3 text-sm border-t border-oat-300">
        <div className="flex justify-between">
          <dt className="text-espresso-500">
            Subtotal ({itemCount} {itemCount === 1 ? "item" : "items"})
          </dt>
          <dd className="font-medium text-espresso-900">{formatPrice(subtotal)}</dd>
        </div>
        <div className="flex justify-between">
          <dt className="text-espresso-500">Delivery</dt>
          <dd className="font-medium text-success">Free</dd>
        </div>
        <div className="flex justify-between pt-3 border-t border-oat-300">
          <dt className="text-base font-semibold text-espresso-900">Total</dt>
